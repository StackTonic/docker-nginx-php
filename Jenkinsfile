...
pipeline {
    ...
    parameters {
        ...
        string(name: 'BASE_IMAGE_NAME', defaultValue: 'stacktonic/nginx', description: 'What is the base image name?')
...
'''
    ...
    stages {
        stage('Get Code') {
            steps {
                git branch:'main', url: 'https://github.com/StackTonic/docker-nginx-php.git'
            }
        }
